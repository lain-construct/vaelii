/*! htmx 2.0.9 | 0BSD (Zero-Clause BSD) | https://htmx.org | vendored & self-hosted (no CDN). Update deliberately: replace this file from the pinned version above and bump the version in this banner. See licenses/THIRD-PARTY.md. */
