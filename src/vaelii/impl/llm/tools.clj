...
(def ^:private param-doc
  ...
  '{sentence "A sentence as an EDN s-expression: \"(dog Fido)\", \"(parentOf ?x Tom)\"."
    ...
    term     "A single term (predicate, individual, type, or context name): \"Fido\"."
    terms    "Terms to intersect on, as EDN strings: [\"Fido\", \"dog\"]."
    handle   "A sentex handle — the integer id a stored sentex is referenced by."
    jid      "A justification id."
    x        "An individual: \"Fido\"."
    t        "A type: \"dog\"."
