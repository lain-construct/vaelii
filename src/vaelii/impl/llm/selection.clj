...
(def ^:private worked-example
  ...
  (str "### Example\n\n"
       ...
       "Instruction: Tom is Ann's father, and Fido belongs to Ann.\n\n"
       "Your whole answer:\n\n"
       "[(fatherOf Tom Ann) WellContext]\n"
       "[(dog Fido) WellContext]\n"
       "[(ownedBy Fido Ann) WellContext]\n\n"
