...
(def ^:private backend-ns
  ...
  {:ollama    'vaelii.host.llm.ollama
   :anthropic 'vaelii.host.llm.anthropic})
...
(defn generation-provider
  "The provider for a **generation** turn (`vaelii.host.llm.session/propose-page`) —
