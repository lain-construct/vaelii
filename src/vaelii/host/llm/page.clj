...
(defn page-context
  ...
  `vaelii.host.llm.session/propose-page`, because which context knowledge lands in is a
...
(defn user-turn
  ...
  `opts` is passed through to `vaelii.host.llm.inventory/inventory` and `render`
