...
(ns vaelii.temporal-functional-in-arg-test
  ...
  and in the rule-conclusion path, and the producer — the third door — called none of
  ...
  doors make it.  What the tests here pin is the *equivalence*: a computed edge and a
  ...
  reified `cx/` context is not wired under CxUniverse by anything — its cone is what the
